...
const SoinsRebozo = () => {
  ...
  return (
    <div id="soins-rebozo" className="bg-[#FFE8D6] min-h-[600px]">
          ...
          <div className="w-fit mx-auto grid grid-cols-1 md:grid-cols-2 justify-items-center justify-center gap-y-20 gap-x-14 mt-10 mb-5">
            {soinsrebozo.map((soin, index) => (
              <div
                ...
                className={`border border-[#fff] rounded-lg p-6 mb-2 bg-[#FCD5CE] w-[550px] relative ${expandedCard === index ? '' : 'max-h-[450px]'}`}
